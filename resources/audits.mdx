---
title: Audits
description: Security and audit information
icon: badge-check
---

## Security and Audits

Security is fundamental to our operations at Jumper (Powered by LI.FI). Our approach combines multiple layers of defense, independent verification, and complete transparency with our users and partners.
...
These tests are conducted annually and cover:
...
All audit reports are publicly available for review: [**LI.FI Smart Contract Audit Reports**](https://github.com/lifinance/contracts/tree/main/audit/reports)
...
Throughout 2024, we have expanded our monitoring infrastructure to include:
...
Our team receives ongoing security training to maintain current knowledge of evolving threat landscapes.

We maintain two non-negotiable commitments:
1. Mandatory independent audits for all smart contract deployments
2. Public disclosure of all audit reports
